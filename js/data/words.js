...
export const WORD_POOLS = {
  ...
  // ── 1º ANO — Palavras do menor para o maior ──────────────────────
  ano1: [
    // Palavras muito curtas (2 letras)
    { text: "eu", type: "single" },
    { text: "da", type: "single" },
    { text: "do", type: "single" },
    { text: "de", type: "single" },
    ...
    { text: "no", type: "single" },
    { text: "um", type: "single" },
    // Monossílabas simples
    { text: "pá", type: "single" },
    { text: "pé", type: "single" },
    { text: "pó", type: "single" },
    { text: "lá", type: "single" },
    { text: "chá", type: "single" },
    { text: "fé", type: "single" },
    { text: "dó", type: "single" },
    // Monossílabas substantivos
    { text: "mãe", type: "single" },
    { text: "pai", type: "single" },
    { text: "sol", type: "single" },
    { text: "mar", type: "single" },
    { text: "mel", type: "single" },
    { text: "flor", type: "single" },
    { text: "cor", type: "single" },
    { text: "bar", type: "single" },
    { text: "boi", type: "single" },
    { text: "lua", type: "single" },
    { text: "pau", type: "single" },
    { text: "rei", type: "single" },
    { text: "ovo", type: "single" },
    // Dissílabas — grupo 1
    { text: "bola", type: "single" },
    { text: "casa", type: "single" },
    { text: "mesa", type: "single" },
    { text: "gato", type: "single" },
    { text: "pato", type: "single" },
    { text: "dedo", type: "single" },
    { text: "faca", type: "single" },
    { text: "cama", type: "single" },
    { text: "boca", type: "single" },
    { text: "mala", type: "single" },
    { text: "rato", type: "single" },
    { text: "sapo", type: "single" },
    { text: "lobo", type: "single" },
    { text: "pipa", type: "single" },
    { text: "vela", type: "single" },
    { text: "tatu", type: "single" },
    { text: "lata", type: "single" },
    { text: "bala", type: "single" },
    { text: "bico", type: "single" },
    { text: "bule", type: "single" },
    // Dissílabas — grupo 2
    { text: "lona", type: "single" },
    { text: "pote", type: "single" },
    { text: "pano", type: "single" },
    { text: "fita", type: "single" },
    { text: "fogo", type: "single" },
    { text: "galo", type: "single" },
    { text: "goma", type: "single" },
    { text: "gelo", type: "single" },
    { text: "mato", type: "single" },
    { text: "mola", type: "single" },
    { text: "nabo", type: "single" },
    { text: "nave", type: "single" },
    { text: "nota", type: "single" },
    { text: "pata", type: "single" },
    { text: "pena", type: "single" },
    { text: "pulo", type: "single" },
    { text: "roda", type: "single" },
    { text: "rosa", type: "single" },
    // Dissílabas — grupo 3
    { text: "saco", type: "single" },
    { text: "sala", type: "single" },
    { text: "sino", type: "single" },
    { text: "sopa", type: "single" },
    { text: "tela", type: "single" },
    { text: "teto", type: "single" },
    { text: "taco", type: "single" },
    { text: "tubo", type: "single" },
    { text: "vaca", type: "single" },
    { text: "vida", type: "single" },
    { text: "vila", type: "single" },
    { text: "zebra", type: "single" },
    { text: "zero", type: "single" },
    { text: "zona", type: "single" },
    // Polissílabas — família e escola
    { text: "mamãe", type: "single" },
    { text: "papai", type: "single" },
    { text: "bebê", type: "single" },
    { text: "amigo", type: "single" },
    { text: "amiga", type: "single" },
    { text: "escola", type: "single" },
    { text: "aluno", type: "single" },
    { text: "livro", type: "single" },
    { text: "cola", type: "single" },
    { text: "lápis", type: "single" },
    
    // Frutas
    { text: "banana", type: "single" },
    { text: "batata", type: "single" },
    { text: "tomate", type: "single" },
    { text: "uva", type: "single" },
    { text: "maçã", type: "single" },
    { text: "pera", type: "single" },
    { text: "caju", type: "single" },
    { text: "melão", type: "single" },
    // Animais
    { text: "cachorro", type: "single" },
    { text: "peixe", type: "single" },
    { text: "leão", type: "single" },
    { text: "tigre", type: "single" },
    { text: "urso", type: "single" },
    { text: "macaco", type: "single" },
    { text: "cavalo", type: "single" },
    // Verbos
    { text: "brincar", type: "single" },
    { text: "correr", type: "single" },
    { text: "pular", type: "single" },
    { text: "cantar", type: "single" },
    { text: "dançar", type: "single" },
    { text: "andar", type: "single" },
    { text: "comer", type: "single" },
    { text: "beber", type: "single" },
    { text: "dormir", type: "single" },
    { text: "estudar", type: "single" },
  ],
